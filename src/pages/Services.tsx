...
const emptyForm: ServiceForm = {
  service_name: '', category: 'printing', default_price: 0, affects_inventory: false, is_active: true,
};
...
const Services = () => {
  ...
  const handleEdit = (s: typeof services[0]) => {
    setForm({
      service_name: s.service_name, category: s.category,
      default_price: Number(s.default_price), affects_inventory: s.affects_inventory, is_active: s.is_active,
    });
    setEditingId(s.id);
    setDialogOpen(true);
  };
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manage service offerings and pricing</p>
        </div>
