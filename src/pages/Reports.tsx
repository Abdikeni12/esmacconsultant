...
const Reports = () => {
  ...
  const exportPDF = () => {
    const html = `
      ...
      <style>body{font-family:sans-serif;padding:40px}table{width:100%;border-collapse:collapse;margin-top:20px}th,td{border:1px solid #ddd;padding:8px;text-align:left}th{background:#f5f5f5}.header{text-align:center;margin-bottom:30px}h1{color:#B5541B}.footer{text-align:center;margin-top:40px;font-size:12px;color:#888}</style>
      </head><body>
      ...
      <div class="footer">Prepared by Abdikeni Hussein Hirsi — ESMAC Consultant</div>
      </body></html>`;
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-center text-xs text-muted-foreground">Prepared by Abdikeni Hussein Hirsi — ESMAC Consultant</p>
    </div>
  );
};
